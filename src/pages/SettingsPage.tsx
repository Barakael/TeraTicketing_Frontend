...
import { User, Shield, Database, Bell, Palette, Globe, Save } from 'lucide-react';
          ...
          <div className="flex items-center space-x-4 mb-6">
            ...
            <div>
              ...
              <Badge variant={
                ...
                user?.role === 'department_leader' ? 'warning' : 'info'
              }>
                {user?.role?.replace('_', ' ')}
              </Badge>
            </div>
        ...
        <div className="bg-gradient-to-r from-gray-100 to-blue-50 dark:from-gray-900 dark:to-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
          <div className="space-y-6">
            {['admin', 'department_leader', 'troubleshooter'].map((role) => (
              <div key={role} className="border-b border-gray-200 dark:border-gray-700 pb-4 last:border-b-0">
                  ...
                  {[
                    ...
                    <label key={permission} className="flex items-center space-x-2">
                      <input
                        ...
                        defaultChecked={
                          role === 'admin' ||
                          (role === 'department_leader' && !['Delete Tickets', 'Manage Users', 'System Settings'].includes(permission)) ||
                          (role === 'troubleshooter' && ['View All Tickets', 'Create Tickets', 'Edit Tickets'].includes(permission))
                        }
    ...
    <div className="space-y-12 grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <div>
        ...
        <div className="bg-gradient-to-l from-gray-100 to-blue-50 dark:from-gray-900 dark:to-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
          <div className="space-y-6">
            {[
              { key: 'enableNotifications', label: 'Enable Push Notifications', description: 'Receive browser notifications for new tickets' },
              { key: 'enableEmailAlerts', label: 'Enable Email Alerts', description: 'Send email notifications for ticket updates' },
              { key: 'autoAssignTickets', label: 'Auto-assign Tickets', description: 'Automatically assign tickets to available troubleshooters' },
              { key: 'requireApproval', label: 'Require Leader Approval', description: 'Department leaders must approve ticket closures' },
            ].map((setting) => (
